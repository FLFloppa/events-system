...
{
    [CustomEditor(typeof(FeatureListDispatchConfiguratorAsset))]
    public sealed class FeatureListDispatchConfiguratorAssetInspector : UnityEditor.Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            root.Add(InspectorUi.Layout.CreateHeader(
                "Feature List Dispatch Configurator",
                "Collect dispatch feature bindings from reusable collections and local overrides."));

            root.Add(InspectorUi.Cards.Create(
                "Collection Sources",
                out var collectionsContent,
                "Collections allow you to reuse curated sets of dispatch feature bindings."));
            collectionsContent.Add(CreateListContainer(_collectionsList));

            root.Add(InspectorUi.Cards.Create(
                "Local Bindings",
                out var localContent,
                "Local bindings are appended after collection bindings, enabling overrides or additions."));
